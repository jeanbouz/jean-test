...
func InitializeRouter() *mux.Router {
	...
	// - Methods() defines the HTTP method which is manage by our route
	...
	router.HandleFunc("/cars", controllers.CarsHandler)
	router.HandleFunc("/customers", controllers.CustomersHandler)
	router.HandleFunc("/userrs", controllers.UsersHandler)

	router.Methods("POST").Path("/car/add").Name("Create").HandlerFunc(controllers.CarsCreate)
